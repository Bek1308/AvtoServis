...
namespace AvtoServis.Forms.Controls
{
    public partial class ServiceControl : UserControl
    {
        ...
        private void SetToolTips()
        {
            ...
            toolTip.SetToolTip(addButton, "Добавить новую услугу");
            ...
            toolTip.SetToolTip(dataGridView, "Таблица с данными об услугах");
        }
        ...
        private void BtnExport_Click(object sender, EventArgs e)
        {
            try
            {
                using (var saveFileDialog = new SaveFileDialog())
                {
                    ...
                    saveFileDialog.FileName = $"Services_{DateTime.Now:yyyyMMdd_HHmmss}.xlsx";
        ...
        private void BtnOpenFilterDialog_Click(object sender, EventArgs e)
        {
            ...
            {
                UpdateVisibleColumns();
                using (var dialog = new FilterDialog(_viewModel))
                {
        ...
        private void SortDataSource()
        {
            ...
            {
                case "ServiceID":
                    dataSource.Sort((x, y) => _sortOrder == SortOrder.Ascending ? x.ServiceID.CompareTo(y.ServiceID) : y.ServiceID.CompareTo(x.ServiceID));
                    break;
                case "Name":
                    dataSource.Sort((x, y) => _sortOrder == SortOrder.Ascending ? string.Compare(x.Name, y.Name) : string.Compare(y.Name, x.Name));
                    break;
                case "Price":
                    dataSource.Sort((x, y) => _sortOrder == SortOrder.Ascending ? x.Price.CompareTo(y.Price) : y.Price.CompareTo(x.Price));
                    break;
            }
        }
