namespace AvtoServis.Forms.Controls
{
    partial class PartsControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            tableLayoutPanel.Controls.Add(btnManageQualities, 1, 3);
            ...
            // titleLabel
            // 
            titleLabel.AccessibleDescription = "Заголовок списка деталей";
            titleLabel.AccessibleName = "Список деталей";
            ...
            titleLabel.Text = "Список деталей";
            // 
            // addButton
            // 
            addButton.AccessibleDescription = "Открывает форму для добавления новой детали";
            addButton.AccessibleName = "Новая деталь";
            ...
            // searchBox
            // 
            searchBox.AccessibleDescription = "Введите каталожный номер или название детали для поиска";
            searchBox.AccessibleName = "Поиск деталей";
            ...
            // countLabel
            // 
            countLabel.AccessibleDescription = "Показывает общее количество деталей";
            countLabel.AccessibleName = "Количество деталей";
            ...
            // btnOpenFilterDialog
            // 
            btnOpenFilterDialog.AccessibleDescription = "Открывает окно для фильтрации деталей";
            ...
            // btnRefresh
            // 
            btnRefresh.AccessibleDescription = "Обновляет список деталей";
            ...
            // btnExport
            // 
            btnExport.AccessibleDescription = "Экспортирует список деталей в Excel файл";
            ...
            // btnManageQualities
            // 
            btnManageQualities.AccessibleDescription = "Открывает окно для управления качествами деталей";
            btnManageQualities.AccessibleName = "Управление качествами";
            btnManageQualities.Anchor = AnchorStyles.Left;
            ...
            // dataGridView
            // 
            dataGridView.AccessibleDescription = "Отображает список деталей с возможностью редактирования, удаления и просмотра деталей";
            dataGridView.AccessibleName = "Таблица деталей";
