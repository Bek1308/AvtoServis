...
{
    public partial class CarBrandFilterDialog : Form
    {
        ...
        public CarBrandFilterDialog(CarBrandViewModel viewModel)
        {
        ...
        {
            toolTip.SetToolTip(tableLayoutPanel, "Форма для фильтрации марок автомобилей");
            toolTip.SetToolTip(titleLabel, "Заголовок фильтров марок");
        ...
        private void ErrorTimer_Tick(object sender, EventArgs e)
        {
            lblError.Visible = false;
            _errorTimer.Stop();
            AdjustFormSize(); // Xato yorlig'i yashirilganda forma o'lchamini qayta hisoblash
        }
        ...
        private void ShowError(string message)
        {
            ...
            _errorTimer.Stop();
            _errorTimer.Start();
            AdjustFormSize(); // Xato yorlig'i ko'rsatilganda forma o'lchamini qayta hisoblash
        }
