...
{
    public partial class PartQualityFilterDialog : Form
    {
        ...
        public PartQualityFilterDialog(PartQualitiesViewModel viewModel)
        {
        ...
        {
            toolTip.SetToolTip(tableLayoutPanel, "Форма для фильтрации качеств запчастей");
            toolTip.SetToolTip(titleLabel, "Заголовок фильтров качеств запчастей");
        ...
        private void BtnApply_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!Filters.Any())
                {
                    ShowError("Добавьте хотя бы один фильтр с текстом поиска.");
                    return;
                }

                _viewModel.Filters = Filters;
                _viewModel.LoadPartQualities();
