...
{
    public partial class PartsIncomeFilterDialog : Form
    {
        ...
        public PartsIncomeFilterDialog(PartsIncomeViewModel viewModel)
        {
        ...
        {
            toolTip.SetToolTip(tableLayoutPanel, "Форма для фильтрации поступлений деталей");
            toolTip.SetToolTip(titleLabel, "Заголовок фильтров поступлений деталей");
