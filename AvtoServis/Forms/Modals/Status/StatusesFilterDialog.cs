...
{
    public partial class StatusesFilterDialog : Form
    {
        ...
        public StatusesFilterDialog(StatusesViewModel viewModel)
        {
        ...
        {
            toolTip.SetToolTip(tableLayoutPanel, "Форма для фильтрации статусов");
            toolTip.SetToolTip(titleLabel, "Заголовок фильтров статусов");
