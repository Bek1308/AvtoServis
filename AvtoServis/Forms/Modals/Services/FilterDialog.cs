...
namespace AvtoServis.Forms.Controls
{
    public partial class FilterDialog : Form
    {
        ...
        public FilterDialog(ServicesViewModel viewModel)
        {
        ...
        {
            toolTip.SetToolTip(tableLayoutPanel, "Форма для фильтрации услуг");
            toolTip.SetToolTip(titleLabel, "Заголовок фильтров услуг");
