...
{
    public partial class ManufacturerFilterDialog : Form
    {
        ...
        public ManufacturerFilterDialog(ManufacturersViewModel viewModel)
        {
        ...
        {
            toolTip.SetToolTip(tableLayoutPanel, "Форма для фильтрации производителей");
            toolTip.SetToolTip(titleLabel, "Заголовок фильтров производителей");
